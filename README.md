...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `44.2µs` | `78.4µs` |
| [Day 2](./src/bin/02.rs) | `50.5µs` | `695.4µs` |
| [Day 3](./src/bin/03.rs) | `251.6µs` | `371.3µs` |
| [Day 4](./src/bin/04.rs) | `149.8µs` | `49.6µs` |
| [Day 5](./src/bin/05.rs) | `1.5ms` | `27.8ms` |
| [Day 6](./src/bin/06.rs) | `307.7µs` | `602.0ms` |
| [Day 7](./src/bin/07.rs) | `55.3ms` | `609.4ms` |
| [Day 8](./src/bin/08.rs) | `28.4µs` | `107.2µs` |
